...
import { getSourceAudio } from '@/Pages/Clients/SinhVien/HocTap/OnLuyen/utils'
          ...
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: DOMPurify.sanitize(
                `<span style="margin-right: 0.2rem; color: #FF4757; white-space: nowrap;">Câu hỏi ${STT}:</span> ${CauHoi}`,
              ),
            }}
          />
          ...
          {IDCauTraLoi1 && (
            ...
            >
              <div className="flex gap-4">
                <div
                  dangerouslySetInnerHTML={{
                    __html: DOMPurify.sanitize(`A.  ${CauTraLoi1}`),
                  }}
                />
              </div>
            </Radio>
          ...
          {IDCauTraLoi2 && (
            ...
            >
              <div className="flex gap-4">
                <div
                  dangerouslySetInnerHTML={{
                    __html: DOMPurify.sanitize(`B.  ${CauTraLoi2}`),
                  }}
                />
              </div>
            </Radio>
          ...
          {IDCauTraLoi3 && (
            ...
            >
              <div className="flex gap-4">
                <div
                  dangerouslySetInnerHTML={{
                    __html: DOMPurify.sanitize(`C.  ${CauTraLoi3}`),
                  }}
                />
              </div>
            </Radio>
          ...
          {IDCauTraLoi4 && (
            ...
            >
              <div className="flex gap-4">
                <div
                  dangerouslySetInnerHTML={{
                    __html: DOMPurify.sanitize(`D.  ${CauTraLoi4}`),
                  }}
                />
              </div>
            </Radio>
