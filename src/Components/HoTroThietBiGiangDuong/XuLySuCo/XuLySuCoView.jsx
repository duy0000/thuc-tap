...
function XuLySuCoView() {
  ...
  useEffect(() => {
    ...
    getAllKhacPhucXuLySuCo({
      DT_CVNB_TBGD_TL_Nhom1: 'TrucThietBiGiangDuong',
  ...
  const handleSubmitData = () => {
    ...
    nguyenNhan.forEach((nn) => {
      danhSachNguyenNhan +=
        nn + '_' + dayjs(new Date()).format('DD/MM/YYYY hh:mm:ss A') + ';'
    })
    ...
    khacPhuc.forEach((kp) => {
      danhSachKhacPhuc +=
        kp + '_' + dayjs(new Date()).format('DD/MM/YYYY hh:mm:ss A') + ';'
    })
