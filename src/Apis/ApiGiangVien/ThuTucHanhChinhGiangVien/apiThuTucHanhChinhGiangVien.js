...
export const putHienThiHoSoThuTuc = (idThuTuc, type) => {
  return http.put('SP_MC_TTHC_GV_TiepNhan/HienThi_ThuTuc_Edit_para', {
    ...
    MC_TTHC_GV_Active: parseInt(type),
  })
}
...
/**
 *
 * @param {*} dieuKienLoc 0: Tất cả, 1: Cần xử lý, 2: Sắp đến hạn, 3: Quán hạn
 * @param {*} maNhanSu
 * @returns
 */
...
export const getKiemTraTrungTTHCGVEditPara = (idThuTuc, maThuTuc) => {
...
export const getAllCanBoXuLy = () =>
  http.get('SP_MC_TTHC_GV_PhanQuyenTiepNhan/Load_CanBoXuLy')
