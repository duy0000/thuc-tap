...
import { getMenuWithSearchParams } from '@/Services/Utils/menuUtils'

const SidebarCongViec = (props) => {
  ...
  return (
    <>
      <div
        className={clsx(
          'h-full p-3 overflow-hidden rounded-2xl bg-white shadow-xl',
      ...
      >
        ...
        {getMenuWithSearchParams(sidebarList)}
      </div>
    </>
  )
}

SidebarCongViec.propTypes = {}

export default SidebarCongViec
