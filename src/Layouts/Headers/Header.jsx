...
import { decryptAESWithKey } from '@/Services/Utils/cryptographyUtils.js'
...
function Header() {
  ...
  return (
    <header className="shadow-md sticky left-0 right-0 top-0 w-[100%] z-[10]">
          ...
          >
            ...
            >
              ...
              <img
                ...
                src={
                  decryptAESWithKey(role) === '0' ? noAvatar : dataSV.HinhAnh
                }
                alt="user photo"
              />
              <span className="hidden md:block">
                {decryptAESWithKey(role) === '0'
