...
function HomeTTHCGVView(props) {
  const { home, loading, dataListHoSoThuTuc, onChangeFilter } = props
  ...
  const displayData = useMemo(() => {
    return dataListHoSoThuTuc
      .filter((tthc) => tthc.MC_TTHC_GV_Active !== false)
      ?.slice(currentPage * itemsPerPage, (currentPage + 1) * itemsPerPage)
  }, [dataListHoSoThuTuc, currentPage, itemsPerPage])
      ...
      {loading ? (
        ...
        <div className="flex flex-col md:flex-row gap-2">
          <div className="bg-white p-4">
            <SidebarTTHCGV
              setKeywords={onChangeFilter}
              setDieuKienLoc={onChangeFilter}
            />
          </div>
          <div className="grow bg-white w-full p-4">
            ...
            <div className="my-5 relative z-[1] w-full h-[200px] overflow-y-auto">
              ...
              {displayData?.length > 0 && (
                <>
                  <table className="w-full max-h-[200px]">
                    <thead className="sticky top-0 z-[1] w-full bg-[#075985] text-white rounded-t-xl">
                      <tr>
