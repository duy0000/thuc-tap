                              ...
                              >
                                ...
                                <td className="px-2 py-1 border border-slate-300">
                                  <div className="flex flex-col gap-2">
                                    <input
                                      type="file"
                                      accept=".pdf, .docx, .doc, .jpeg, .jpg, .png, .gif, .xls, .xlsx, .zip, .7z, .gz, .rar"
                                      onChange={(e) => {
                                        const file = e.target.files[0]
                                        const maxSizeInBytes = 5 * 1024 * 1024 // 5MB
                                        if (
                                          !file.name.match(
                                            /\.(pdf|docx|doc|jpeg|jpg|png|gif|xls|xlsx|zip|7z|gz|rar)$/i,
                                          )
                                        ) {
                                          Swal.fire({
                                            icon: 'error',
                                            ...
                                            text: 'Các loại file tải lên phải có dạng PDF, XLS, XLSX, DOC, DOCX, ZIP, 7Z, GZ, RAR, PNG, JPG, JPEG hoặc GIF(Kích thước tối đa 5MB)',
                                          })
                                          return
                                        } else {
                                    ...
                                    <span className="mt-1 text-sm text-gray-500 dark:text-gray-300">
                                      ...
                                      <span className="font-medium">GZ</span>,{' '}
