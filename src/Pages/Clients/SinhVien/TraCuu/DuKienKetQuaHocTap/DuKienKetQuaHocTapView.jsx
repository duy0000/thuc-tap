                    ...
                    <table className="w-full text-vs-text text-sm rounded-3xl">
                      <thead className="font-semibold">
                        <tr>
                          <th
                            rowSpan={2}
                            className=" py-4 w-12 sticky left-0 bg-[#F0FBFF] border border-solid border-uneti-primary border-opacity-30 border-t-0 border-l-0"
                          >
                            STT
                          ...
                          <th
                            rowSpan={2}
                            className=" py-4 w-[300px] sticky left-[50px] bg-[#F0FBFF] border border-solid border-uneti-primary border-opacity-30 border-t-0 border-l-0 border-r-0"
                          >
                            Tên môn học
                            <span className="absolute w-[1px] h-[100%] top-0 right-[-0.5px] bg-uneti-primary opacity-30"></span>
                          </th>
                          <th
                            rowSpan={2}
                            className=" py-4 w-[200px] bg-[#F0FBFF] border border-solid border-uneti-primary border-opacity-30 border-t-0 border-l-0"
                          >
                            Mã học phần
                          </th>
                          <th
                            rowSpan={2}
                            className=" py-4 w-[100px] bg-[#F0FBFF] border border-solid border-uneti-primary border-opacity-30 border-t-0"
                          >
                            Số tín chỉ
                          </th>
                          ...
                          <th
                            colSpan={2}
                            className=" p-4 w-[100px] bg-[#F0FBFF] border border-solid border-uneti-primary border-opacity-30 border-t-0"
                          >
                            Điểm tổng kết
                          </th>
                          <th
                            colSpan={2}
                            className=" p-4 w-[100px] bg-[#F0FBFF] border border-solid border-uneti-primary border-opacity-30 border-t-0 border-r-0"
                          >
                            Điểm tổng kết dự kiến
                          </th>
                        </tr>
                        <tr>
                          <th className=" p-4 w-[100px] bg-[#F0FBFF] border border-solid border-uneti-primary border-opacity-30 border-t-0 border-r-0">
                            Hệ 10
                          </th>
                          <th className=" p-4 w-[100px] bg-[#F0FBFF] border border-solid border-uneti-primary border-opacity-30 border-t-0 border-r-0">
                            Hệ 4
                      ...
                      <tbody>
                        ...
                        })}
                        {
                          <tr>
                            <td
                              colSpan={3}
                              className="text-center border border-solid border-uneti-primary border-opacity-30 border-b-0 border-l-0 py-2"
                            >
                              Tổng số tín chỉ tích lũy
                            </td>
                            <td className="text-center border border-solid border-uneti-primary border-opacity-30 border-b-0 border-l-0 py-2">
                              {listDiemThucTe?.length > 0 &&
                                listDiemThucTe?.map((tt) => {
                                  if (hk === tt?.TC_SV_KetQuaHocTap_TenDot) {
                                    return tt?.TC_SV_KetQuaHocTap_TongTinChi_TichLuyHocKy
                                  }
                                  return ''
                                })}
                            </td>
                            <td className="text-center border border-solid border-uneti-primary border-opacity-30 border-b-0 border-l-0 py-2"></td>
                            <td className="text-center border border-solid border-uneti-primary border-opacity-30 border-b-0 border-l-0 py-2"></td>
                            <td className="text-center border border-solid border-uneti-primary border-opacity-30 border-b-0 border-l-0 py-2"></td>
                            <td className="text-center border border-solid border-uneti-primary border-opacity-30 border-b-0 border-l-0 py-2"></td>
                          </tr>
