...
function DanhSachDeThi() {
  ...
  const handlePostData = async () => {
    ...
    if (idChuong != 'all') {
      ...
      console.log(
        '🚀 ~ file: DanhSachCauHoi.jsx:236 ~ handlePostData ~ data:',
        data,
      )

      // danh sách ôn tập
      const checkPostOnTap = await postDanhSachOnTap(data)

      console.log(
        '🚀 ~ file: DanhSachCauHoi.jsx:244 ~ handlePostData ~ checkPostOnTap:',
        checkPostOnTap,
      )
    }
