...
export const HoTroSuDungPhanMem = () => {
  ...
  useEffect(() => {
    // if (Object.keys(queryParams)[0] && Object.values(queryParams)[0]) {
    setCategory({
      categoryParent: {
        ...category.categoryParent,
        path: Object.keys(queryParams)[0],
        value: Object.keys(queryParams)[0],
      },
      categoryChild: {
        ...category.categoryChild,
        path: Object.values(queryParams)[0],
        value: Object.values(queryParams)[0],
      },
    })
    // }
  }, [Object.keys(queryParams)[0], Object.values(queryParams)[0]])
