...
export const ENUM_STATE_TTHCGV = {
  TAT_CA: 'tat-ca',
  CAN_XU_LY: 'can-xu-ly',
  SAP_DEN_HAN_1_NGAY: 'sap-den-han-1-ngay',
  QUA_HAN: 'qua-han',
}
...
export const MC_TTHC_GV_DoiTuongXuLy_PheDuyet = [
  {
    id: '24',
    name: 'Duyệt (Trưởng/Phó đơn vị)',
  },
  {
    id: '25',
    name: 'Duyệt (Ban giám hiệu)',
  },
]
...
export const listYeuCauPheDuyet = [
  ...
  },
  {
    id: 3,
    value: 3,
    label: 'Ban giám hiệu đã phê duyệt',
  },
]
