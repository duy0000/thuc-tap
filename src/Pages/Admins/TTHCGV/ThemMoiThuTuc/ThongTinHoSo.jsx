...
const ThongTinHoSo = memo(function ThongTinHoSo(props) {
  ...
  console.log('dataFilesTepThuTuc: ', dataFilesTepThuTuc)
  return (
            ...
            <>
              ...
              <input
                ...
                onChange={async (e) => {
                  ...
                  if (
                    !file.name.match(
                      /\.(pdf|docx|doc|jpeg|jpg|png|gif|xls|xlsx)$/i,
                    )
                  ) {
                    Swal.fire({
                      icon: 'error',
                      ...
                      text: 'Các loại file tải lên phải có dạng PDF, XLS, XLSX, DOC, DOCX, PNG, JPG, JPEG hoặc GIF(Kích thước tối đa 5MB)',
                    })
