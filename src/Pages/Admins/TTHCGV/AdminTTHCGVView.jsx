...
import { postThuTucHanhChinh } from '../../../Apis/ApiGiangVien/ThuTucHanhChinhGiangVien/apiThuTucHanhChinhGiangVien'
import { NguonTiepNhan_WEB } from '../../../Services/Static/dataStatic'
import Swal from 'sweetalert2'
import { postThanhPhanHoSoTTHCGV } from './../../../Apis/ApiGiangVien/ThuTucHanhChinhGiangVien/apiThanhPhanHoSo'
import { postTrinhTuThucHienTTHCGV } from './../../../Apis/ApiGiangVien/ThuTucHanhChinhGiangVien/apiTrinhTuThucHien'
import { postTrangThaiTTHCGV } from './../../../Apis/ApiGiangVien/ThuTucHanhChinhGiangVien/apiTrangThai'
import { getThuTucHanhChinhByMaThuTuc } from './../../../Apis/ApiGiangVien/ThuTucHanhChinhGiangVien/apiThuTucHanhChinhGiangVien'
import { postPhanQuyenTTHCGV } from '../../../Apis/ApiGiangVien/ThuTucHanhChinhGiangVien/apiPhanQuyen'
...
function AdminTTHCGVView({
  ...
  const handleOnSubmitForm = async (e) => {
    ...
    // console.log('1 - phanquyen: ', phanQuyen)
  ...
  return (
    <div className="px-5 lg:px-0 grid grid-cols-12 gap-4 ">
      ...
      >
        ...
        <form
          className={clsx('w-full', zoomView ? ' min-h-[400px]' : '')}
