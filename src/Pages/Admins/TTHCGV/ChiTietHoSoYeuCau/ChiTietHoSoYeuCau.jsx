...
import { getListNoiTraKetQua } from '@/Apis/ApiGiangVien/ThuTucHanhChinhGiangVien/apiThuTucHanhChinhGiangVien'
import { getInfoPhanQuyenCBNV } from '@/Apis/ApiGiangVien/ThuTucHanhChinhGiangVien/apiPhanQuyen'
            ...
            <div className="col-span-12 lg:col-span-10">
              <div className="w-full p-4 bg-white shadow-lg rounded-xl">
                ...
                <div className="w-full">
                  ...
                  <div className={clsx(showXuLyHoSo ? '' : 'hidden')}>
                    {/* Trạng thái hồ sơ */}
                    <p className="col-span-2 md:col-span-1 mb-4">
                      Trạng thái hồ sơ:{' '}
                      ...
                      {listTrangThaiYeuCau.map((tt, index) => {
                        return (
                          <li className="mb-10 ms-10" key={index}>
                            ...
                            <div
                              className={clsx(
                                'flex flex-row items-center gap-2 px-2 md:px-5 md:py-2 rounded-2xl',
                                tt?.MC_TTHC_GV_TrangThai_STT ===
                                  dataDetailYeuCau?.MC_TTHC_GV_TrangThai_STT ||
                                  dataDetailYeuCau?.MC_TTHC_GV_TrangThai_STT >
                                    index
                            ...
                            >
                              ...
                              <h3 className="text-[10px] md:text-sm font-medium leading-10 whitespace-nowrap">
                                Bước {index + 1}:{' '}
                        ...
                        {displayedListQuyTrinhXuLy?.map((iQTXuLy, index) => {
                          return (
                            <tr className="border-b" key={index}>
                              ...
                              <td className="border-r p-2 text-justify">
                                <p className="w-72 line-clamp-5 md:line-clamp-none">
