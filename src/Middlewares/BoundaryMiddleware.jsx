...
export default class BoundaryMiddleware extends Component {
  state = {
    hasError: false,
    errorMessage: '',
  }
      ...
      return (
        <div className="flex h-screen w-full flex-col items-center justify-center space-x-8 space-y-16 lg:flex-row lg:space-y-0 2xl:space-x-0">
          <div className="flex w-full flex-col items-center justify-center text-center lg:w-1/2 lg:px-2 xl:px-0">
            <p className="text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider text-red-500">
              500
            </p>
            <p className="lg:text-6xl mt-2 text-4xl font-bold tracking-wider text-red-500 md:text-5xl">
              WebServer Error
            </p>
            <p
              className="text-lg my-12 text-gray-500 md:text-xl lg:text-2xl"
              title={this.state.errorMessage}
            >
              Đã có lỗi xảy ra, vui lòng ấn F5 để reload lại trang <br /> hoặc
              <br /> liên hệ với bộ phận kỹ thuật để khắc phục sự cố!
              <br />
              Xin cảm ơn!
            </p>
          </div>
