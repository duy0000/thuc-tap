export const QTHT_UNETI_ONLINE = '1'
export const NGUON_TIEP_NHAN_WEB = 1
export const SECONDS = 1000
export const MUTATE = SECONDS * 60

export const enumDiaDiemUNETI = {
  CS_456MinhKhai: '1 - 456 Minh Khai',
  CS_454MinhKhai: '2 - 454 Minh Khai',
  CS_218LinhNam: '3 - 218 Lĩnh Nam',
  CS_353TranHungDao: '4 - 353 Trần Hưng Đạo',
  CS_MyXa: '5 - Mỹ Xá',
}

export const MIME_TYPE_EXTENSION_COMMON = [
  ...
  { extension: '.cda', mimeType: 'application/x-cdf' },
  ...
  { extension: '.midi', mimeType: 'audio/x-midi' },
  ...
  { extension: '.opus', mimeType: 'audio/opus' },
...
export const MIME_TYPE_EXT_UNETI = [
  { extension: '.doc', mimeType: 'application/msword' },
  {
    extension: '.docx',
    mimeType:
