...
export const compareStrWithoutSpecialChars = (str1 = '', str2 = '') => {
  return convertVietnameseStrToLatinStr(str1?.trim().toLowerCase()).includes(
    convertVietnameseStrToLatinStr(str2?.trim().toLowerCase()),
  )
}

export const convertVietnameseStrToLatinStr = (str = '') => {
...
export const changeSlug = (dataString = '') => {
  if (dataString !== '') {
    let slug = convertVietnameseStrToLatinStr(dataString)
...
export const convertUint8ArrayToBuffer = (uint8Array) => {
