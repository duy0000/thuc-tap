...
// 2. Module Hỗ trợ thiế bị, phần mềm
export const sendEmail_HTTB_CBNV_NguoiBaoHong = async (
  email,
  TenThietBi,
  MaNhanSuBaoHong,
  HoTenNguoiBaoHong,
  ...
  let subjectEmail = `Thông báo xác nhận sửa chữa thiết bị ${TenThietBi ? TenThietBi.toUpperCase() : ''} theo thông tin báo hỏng (Email tự động, vui lòng không trả lời)`

  let emailHtml = `
        <div>
            <p>Kính gửi Thầy/Cô ${HoTenNguoiBaoHong},</p>
        </div>
        <div>
            <p>Tôi đã xem xét và xác nhận thông tin báo hỏng thiết bị của quý Thầy/Cô, với thông tin như sau:</p>
        </div>
        <div>
            <h4 style="margin-bottom: 0;">A. THÔNG TIN BÁO HỎNG:</h4>
            <p style="margin: 0;"><b>1. Người báo hỏng:</b></p>
            <p style="margin: 0;">&emsp;&emsp;1.1. Mã nhân sự: <b>${MaNhanSuBaoHong}</b></p>
            <p style="margin: 0;">&emsp;&emsp;1.2. Họ và tên: <b>${HoTenNguoiBaoHong}</b></p>
            <p style="margin: 0;">&emsp;&emsp;1.3. Đơn vị quản lý nhân sự: <b>${DonViNguoiBaoHong}</b></p>

            <p style="margin-bottom: 0;"><b>2. Nội dung báo hỏng:</b></p>
            <p style="margin: 0;">&emsp;&emsp;Thời gian báo hỏng: ${dayjs(ThoiGianBaoHong).utc().format('DD/MM/YYYY HH:mm')}</p>
            <p style="margin: 0;">&emsp;&emsp;Thông tin sự cố: ${TenSuCo}</p>
            <p style="margin: 0;">&emsp;&emsp;Mô tả sự cố: ${MoTaSuCo}</p>
        </div>
        <div>
            <h4 style="margin-bottom: 0;">B. THÔNG TIN XỬ LÝ:</h4>
            <p style="margin: 0;"><b>1. Người xử lý:</b></p>
            <p style="margin: 0;">&emsp;&emsp;1.1. Mã nhân sự: <b>${dataUserHandle?.MaNhanSu}</b></p>
            <p style="margin: 0;">&emsp;&emsp;1.2. Họ và tên: <b>${dataUserHandle?.HoDem + ' ' + dataUserHandle?.Ten}</b></p>
            <p style="margin: 0;">&emsp;&emsp;1.3. Đơn vị quản lý nhân sự: <b>${dataUserHandle?.TenPhongBan}</b></p>

            <p style="margin-bottom: 0;"><b>2. Nội dung xử lý:</b></p>
            <p style="margin: 0;">&emsp;&emsp;Tôi đã nhận được thông tin báo hỏng thiết bị ${TenThietBi ? TenThietBi.toUpperCase() : ''} và xác nhận xử lý vào lúc ${dayjs(NgayXuLy).utc().format('DD/MM/YYYY HH:mm').split(' ')[1]} ngày ${dayjs(NgayXuLy).utc().format('DD/MM/YYYY')}</p>
        </div>
        <div>
            <p>Trân trọng!</p>
        </div>
        <div>
            ...
            <p style="margin: 0;">&emsp;+ Điện thoại: ${dataUserHandle?.SoDienThoai}</p>
            <p style="margin: 0;">&emsp;+ Email: ${dataUserHandle?.EmailUneti}</p>
        </div>
    `
  const dataSendEmail = {
    to: email,
...
export const sendEmail_HTTB_CBNV_SVBaoHong = async (
  email,
  TenThietBi,
  MaNhanSuBaoHong,
  HoTenNguoiBaoHong,
  ...
  let emailHtml = `
        <div>
            <p>Thông báo sinh viên ${HoTenNguoiBaoHong},</p>
        </div>
        <div>
            <p>Tôi đã xem xét và xác nhận thông tin báo hỏng thiết bị của sinh viên, với thông tin như sau:</p>
        </div>
        <div>
            <h4 style="margin-bottom: 0;">A. THÔNG TIN BÁO HỎNG:</h4>
            <p style="margin: 0;"><b>1. Người báo hỏng:</b></p>
            <p style="margin: 0;">&emsp;&emsp;1.1. Mã sinh viên: <b>${MaNhanSuBaoHong}</b></p>
            <p style="margin: 0;">&emsp;&emsp;1.2. Họ và tên: <b>${HoTenNguoiBaoHong}</b></p>
            <p style="margin: 0;">&emsp;&emsp;1.3. Khoa: <b>${DonViNguoiBaoHong}</b></p>
        ...
        <div>
            <h4 style="margin-bottom: 0;">LƯU Ý:</h4>
            <p style="margin: 0;">- Đây là email tự động, vui lòng không trả lời (no reply), chúng tôi sẽ không nhận được email phản hồi.</p>
        </div>
    `
  const dataSendEmail = {
    to: email,
...
export const sendEmail_HTTB_XacNhanHoanThanh_NguoiBaoHong = async (
  email,
  TenThietBi,
  MaNhanSuBaoHong,
  HoTenNguoiBaoHong,
  ...
  let subjectEmail = `Thông báo xác nhận hoàn thành sửa chữa thiết bị ${TenThietBi ? TenThietBi.toUpperCase() : ''} theo thông tin báo hỏng (Email tự động, vui lòng không trả lời)`
  ...
  let emailHtml = `
        ...
        <div>
            <p>Tôi đã xem xét và hoàn thành sửa chữa thiết bị của quý Thầy/Cô, với thông tin như sau:</p>
        </div>
        <div>
            <h4 style="margin-bottom: 0;">A. THÔNG TIN BÁO HỎNG:</h4>
            <p style="margin: 0;"><b>1. Người báo hỏng:</b></p>
        ...
        <div>
            ...
            <p style="margin-bottom: 0;"><b>2. Nội dung xử lý:</b></p>
            <p style="margin: 0;">&emsp;&emsp;Tôi đã hoàn thành sửa chữa thiết bị ${TenThietBi ? TenThietBi.toUpperCase() : ''} theo thông tin báo hỏng vào lúc ${dayjs(NgayHoanThanh).utc().format('DD/MM/YYYY HH:mm').split(' ')[1]} ngày ${dayjs(NgayHoanThanh).utc().format('DD/MM/YYYY')}</p>
        </div>
        <div>
            <p>Trân trọng!</p>
        </div>
...
export const sendEmail_HTTB_XacNhanHoanThanh_SVBaoHong = async (
  email,
  TenThietBi,
  MaNhanSuBaoHong,
  HoTenNguoiBaoHong,
  ...
  let emailHtml = `
        ...
        <div>
            <p>Tôi đã xem xét và hoàn thành xử lý thiết bị được sinh viên báo hỏng, với thông tin như sau:</p>
        </div>
        <div>
            <h4 style="margin-bottom: 0;">A. THÔNG TIN BÁO HỎNG:</h4>
            <p style="margin: 0;"><b>1. Người báo hỏng:</b></p>
        ...
        <div>
            ...
            <p style="margin-bottom: 0;"><b>2. Nội dung xử lý:</b></p>
            <p style="margin: 0;">&emsp;&emsp;Tôi đã hoàn thành xử lý cho thiết bị ${TenThietBi ? TenThietBi.toUpperCase() : ''} theo thông tin báo hỏng vào lúc ${dayjs(NgayHoanThanh).utc().format('DD/MM/YYYY HH:mm').split(' ')[1]} ngày ${dayjs(NgayHoanThanh).utc().format('DD/MM/YYYY')}</p>
        </div>
        <div>
            <p>Trân trọng!</p>
        </div>
...
export const sendEmail_HTTB_HuyTra_NguoiBaoHong = async (
  email,
  TenThietBi,
  MaNhanSuBaoHong,
  HoTenNguoiBaoHong,
  ...
  let subjectEmail = `Thông báo hủy trả sửa chữa thiết bị/phần mềm ${TenThietBi ? TenThietBi.toUpperCase() : ''} theo thông tin báo hỏng (Email tự động, vui lòng không trả lời)`
  ...
  let emailHtml = `
        ...
        <div>
            <p>Tôi đã xem xét yêu cầu sửa chữa thiết bị của quý Thầy/Cô, với thông tin như sau:</p>
        </div>
        <div>
            <h4 style="margin-bottom: 0;">A. THÔNG TIN BÁO HỎNG:</h4>
            <p style="margin: 0;"><b>1. Người báo hỏng:</b></p>
        ...
        <div>
            ...
            <p style="margin: 0;">&emsp;&emsp;${noiDungHuyTra}</p>
        </div>
        <div>
            <p>Trân trọng!</p>
        </div>
...
export const sendEmail_HTTB_HuyTra_SVBaoHong = async (
  email,
  TenThietBi,
  MaNhanSuBaoHong,
  HoTenNguoiBaoHong,
  ...
  let subjectEmail = `Thông báo hủy trả yêu cầu sửa chữa thiết bị/phần mềm ${TenThietBi ? TenThietBi.toUpperCase() : ''} theo thông tin báo hỏng (Email tự động, vui lòng không trả lời)`
  ...
  let emailHtml = `
        ...
        <div>
            <p>Tôi đã xem xét yêu cầu xử lý thiết bị/phần mềm được sinh viên báo hỏng, với thông tin như sau:</p>
        </div>
        <div>
            <h4 style="margin-bottom: 0;">A. THÔNG TIN BÁO HỎNG:</h4>
            <p style="margin: 0;"><b>1. Người báo hỏng:</b></p>
